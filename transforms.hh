...
void internalize_var_name(utf8 const & utf, var_name & n);
void internalize_var_name(external const & ext, var_name & n);
void externalize_var_name(var_name const & n, utf8 & utf);
void externalize_var_name(var_name const & n, external & ext);
