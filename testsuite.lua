...
table.insert(tests, "include()_includedir()_and_includedirpattern()_lua_functions")
...
table.insert(tests, "b_t_and_a_selector_globbing")
...
table.insert(tests, "automate_get_file,_automate_get_file_of")
...
table.insert(tests, "netsync_epoch_refinement")
...
table.insert(tests, "netsync_hook_errcodes")
...
table.insert(tests, "checkout_does_not_clobber_workspace")
table.insert(tests, "update_does_not_clobber_workspace")
table.insert(tests, "ls_unknown_in_subdir")
table.insert(tests, "test_a_merge_8")
table.insert(tests, "magic__MTN_in_restrictions")
table.insert(tests, "db_kill_rev_and_recommit")
table.insert(tests, "pluck_does_not_clobber_workspace")
table.insert(tests, "revert_the_middle_of_a_sequence")
table.insert(tests, "locked_workspace")
