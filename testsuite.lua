...
table.insert(tests, "'heads'_with_discontinuous_branches")
...
table.insert(tests, "trust_hooks_and_'trusted'_command")
table.insert(tests, "attr_set_attr_get")
table.insert(tests, "--rcfile_requires_extant_file")
...
table.insert(tests, "--db_with_parent_dir")
...
table.insert(tests, "--author,_--date")
...
table.insert(tests, "workspace_inventory")
...
table.insert(tests, "--rcfile=directory")
...
table.insert(tests, "_MTN_*_handled_correctly_in_aborted_commit")
...
table.insert(tests, "--confdir_option_and_get_confdir_lua_function_work")
