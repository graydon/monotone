...
#define N_THROW(expr) BOOST_CHECK_NOT_THROW(expr, informative_failure)
#define Y_THROW(expr) BOOST_CHECK_THROW(expr, informative_failure)
  ...
  // validate_no_more_args
  {
    ...
    string a; iss >> a; BOOST_CHECK(a == "a");
    string b; iss >> b; BOOST_CHECK(b == "b");
