...
check(qgrep('^delete "dropped"', "stdout"))
check(qgrep('^rename "from"', "stdout"))
check(qgrep('^    to "to"', "stdout"))
check(qgrep('^rename "from_patched"', "stdout"))
check(qgrep('^    to "to_patched"', "stdout"))
check(qgrep('^add_file "added"', "stdout"))
check(qgrep('^patch "patched"', "stdout"))
check(qgrep('^patch "to_patched"', "stdout"))

check(mtn("status", "--brief"), 0, true, false)
...
check(not qgrep('^patch "patched"', "stdout"))
check(qgrep('^patch "to_patched"', "stdout"))
