...
-- We would test migration from format 0 to format 1, but it is not
-- possible to do that migration short of destroying the workspace and
-- starting over (see comments in work_migration.cc).  So we just
-- check that the attempt fails (and leaves the workspace alone).
